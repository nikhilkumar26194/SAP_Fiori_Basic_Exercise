		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "simpleform",
									"targetURL": "#formproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"formproject2-display": {
								"semanticObject": "formproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=form.project2",
									"url": sap.ui.require.toUrl("form/project2")
								}
							}
						}
					}
