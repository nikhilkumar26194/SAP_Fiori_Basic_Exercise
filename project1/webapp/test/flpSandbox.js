		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "gopro1",
									"targetURL": "#gopro1project1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gopro1project1-display": {
								"semanticObject": "gopro1project1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gopro1.project1",
									"url": sap.ui.require.toUrl("gopro1/project1")
								}
							}
						}
					}
